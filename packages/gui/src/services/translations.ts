...
export const i18n = {
  ...
  currentLocale: 'init' as Languages,
  locales: {} as Locales,
  init,
  addOnChangeListener,
  loadAndSetLocale,
...
async function init(locales: Locales, selectedLocale?: Languages) {
  ...
  document.documentElement.setAttribute('lang', selectedLocale || defaultLocale || 'en');
  await loadAndSetLocale(selectedLocale || defaultLocale || 'en');
}
